...
create_contrainer_ring () {
    ...
    # Add each storage node to the ring:
    swift-ring-builder account.builder add r1z1-${object1}:6001/${device1} 100
    swift-ring-builder account.builder add r1z2-${object1}:6001/${device2} 100
    swift-ring-builder account.builder add r1z3-${object2}:6001/${device1} 100
    swift-ring-builder account.builder add r1z4-${object2}:6001/${device2} 100
...
create_object_ring () {
    ...
    # Add each storage node to the ring:
    swift-ring-builder account.builder add r1z1-${object1}:6000/${device1} 100
    swift-ring-builder account.builder add r1z2-${object1}:6000/${device2} 100
    swift-ring-builder account.builder add r1z3-${object2}:6000/${device1} 100
    swift-ring-builder account.builder add r1z4-${object2}:6000/${device2} 100
...
distribute_ring_files () {
    ...
    scp account.ring.gz, container.ring.gz, and object.ring.gz root@${object1}:/etc/swift/
    scp account.ring.gz, container.ring.gz, and object.ring.gz root@${object2}:/etc/swift/
